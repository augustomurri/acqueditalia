...
export default class Helpers {
   ...
   * Example usage:
   *
   * <input type="text" class="js-flatpickr forms-control">
   *
   */
  static jsFlatpickr() {
   ...
   * Example usage:
   *
   * <input type="text" class="js-datepicker forms-control">
   *
   */
  static jqDatepicker() {
   ...
   * Example usage:
   *
   * <input type="text" class="js-colorpicker forms-control" value="#db4a39">
   *
   */
   ...
   * Example usage:
   *
   * <select class="js-select2 forms-control" style="width: 100%;" data-placeholder="Choose one..">
   ...
   * Example usage:
   *
   * <input type="text" class="js-maxlength forms-control" maxlength="20">
   *
   */
  static jqMaxlength() {
   ...
   * Example usage:
   *
   * <input type="text" class="js-rangeslider forms-control" value="50">
   *
   */
